  ...
  const handleRequestClose = () => {
    ...
    return (
      <div className="dashboard animated slideInUpTiny animation-duration-3">
          ...
          <div className="col-lg-3 col-sm-6 col-12">
            <ChartCard styleName="bg-warning text-white">
              ...
              <div className="p-3">
                ...
                <Progress className="shadow-lg mb-2 my-1 progress-height" color="white" value="72"/>
                <div className="d-flex flex-row">
                  <p className="text-white m-0">Bounced</p>
                  <p className="text-white ml-auto m-0">28%</p>
                </div>
                <Progress className="shadow-lg my-1 progress-height" color="white" value="28"/>
              </div>
            </ChartCard>
          </div>
        </div>
            ...
            <div className="jr-card jr-card-equalheight">
              ...
              <div className='jr-card-body'>
                <ResponsiveContainer className='responsive-chart' width="100%">
                  <div className="d-flex justify-content-center" style={{width: "100%", height: "160px"}}>
                    <ReactSpeedometer
                        value={333}
                        fluidWidth
        ...
        <div className="row">
          <CardBox styleName="col-12" cardStyle='mb-0' heading="Site Visitors Statistics" headingStyle="mb-1">
            <SiteVisitor/>
          </CardBox>
        </div>
