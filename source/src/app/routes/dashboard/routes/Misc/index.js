    ...
    return (
      <div className="dashboard animated slideInUpTiny animation-duration-3">
        ...
        <div className="row">
          ...
          <div className="col-lg-5 col-md-8 col-12 order-lg-3 ">
            <div className="jr-card py-3">
              <div className="row">
                ...
                <div className="col-md-8 col-12 text-md-left text-center align-self-center">
        ...
        <div className="row">
          <div className="col-lg-4 col-12">
            <div className='misc-statistics-chartjs'>
              <Statistics/>
            </div>
          </div>
