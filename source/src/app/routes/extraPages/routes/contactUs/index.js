    ...
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row">
        <div className="col-lg-9 col-md-8 col-12">
          <form action="" className="contact-form jr-card mb-md-0">
            <div className="row">
              <div className="col-lg-6 col-12">
                <div className="form-group">
                  <label className='mb-1' form="firstName">Name</label>
              ...
              <div className="col-lg-6 col-12">
                <div className="form-group">
                  <label className='mb-1' htmlFor="lastName">&nbsp;</label>
            ...
            <div className="row">
              <div className="col-12">
                <div className="form-group">
                  <label className='mb-1'>How can we help you?</label>
        ...
        <div className="col-lg-3 col-md-4 col-12">
          <div className="contact-block jr-card mb-0">
