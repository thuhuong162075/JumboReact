  ...
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row">
        ...
        <CardBox styleName="col-lg-3 col-md-6" cardStyle="d-flex justify-content-center"
        ...
        <CardBox styleName="col-lg-3 col-md-6" cardStyle="py-sm-3 text-center"
      ...
      <div className="row">
        <CardBox styleName="col-lg-12" cardStyle="p-0 bg-transparent no-shadow mb-0"
