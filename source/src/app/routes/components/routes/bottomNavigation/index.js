...
const BottomNavigation = ({match}) => {
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row">
        <CardBox styleName="col-lg-4 col-md-6 col-12" cardStyle="mb-lg-0"
                 heading={<IntlMessages id="component.bottomNavigation.withLabels"/>}
                 headerOutside>
          <WithLabelBottomNavigation/>
        </CardBox>

        <CardBox styleName="col-lg-4 col-md-6 col-12 order-lg-3" cardStyle="mb-lg-0"
                 heading={<IntlMessages id="component.bottomNavigation.withActiveLabels"/>}
                 headerOutside>
          <WithoutLabelBottomNavigation/>
        </CardBox>

        <CardBox styleName="col-lg-4 col-md-12 col-12" cardStyle="mb-0"
