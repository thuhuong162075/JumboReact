  ...
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row">
        ...
        <CardBox styleName="col-lg-6 col-sm-6" cardStyle='mb-lg-0' heading={<IntlMessages id="picker.date.dateNTime"/>}>
          <DateAndTimePickers/>
        </CardBox>
        <CardBox styleName="col-lg-6 col-12" cardStyle='mb-0' heading={<IntlMessages id="picker.date.customDate"/>}>
