  ...
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row">
        ...
        <div className="col-lg-4 col-sm-6 col-12">
          <SolidCards headerText="Danger Card" cardStyle="bg-danger text-white mb-lg-0"/>
        </div>

        <div className="col-lg-4 col-sm-6 col-12">
          <SolidCards headerText="Info Card" cardStyle="bg-info text-white mb-sm-0"/>
        </div>

        <div className="col-lg-4 col-sm-6 col-12">
          <SolidCards headerText="Dark Card" cardStyle="bg-dark text-white mb-0"/>
        </div>
