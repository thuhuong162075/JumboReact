  ...
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row">
        ...
        >
          <Chip avatar={<Avatar src="https://via.placeholder.com/128x128"/>} label="Image Avatar"/>
        </CardBox>
        <CardBox
          styleName="col-lg-3 col-md-4 col-sm-6 col-12"
          cardStyle="text-center"
      ...
      <div className="row">
        <CardBox styleName="col-xl-12" cardStyle='mb-0' heading={<IntlMessages id="component.chips.withInput"/>}>
          <ChipsWithInputBox/>
        </CardBox>
      </div>
    </div>
