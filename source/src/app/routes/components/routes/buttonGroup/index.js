  ...
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row">
        ...
        <CardBox styleName="col-xl-4 col-md-4 col-sm-6 col-12" cardStyle="text-center mb-md-0"
                 heading={<IntlMessages id="component.buttonGroup.icon"/>}>
          <div><IntlMessages id="component.buttonGroup.defaultStyle"/></div>
          <IconButtonGroup isVertical/>
        </CardBox>

        <CardBox styleName="col-xl-4 col-md-4 col-sm-6 col-12" cardStyle="text-center mb-sm-0"
                 heading={<IntlMessages
                   id="component.buttonGroup.iconFlat"/>}>
          <div><IntlMessages id="component.buttonGroup.defaultStyle"/></div>
        ...
        <CardBox styleName="col-xl-4 col-md-4 col-sm-6 col-12" cardStyle="text-center mb-0"
                 heading={<IntlMessages id="component.buttonGroup.nested"/>}>
          <div><IntlMessages id="component.buttonGroup.defaultStyle"/></div>
