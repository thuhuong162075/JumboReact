...
const Dialogs = ({match}) => {
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row">
        <CardBox styleName="col-md-6" cardStyle='mb-md-0' childrenStyle="text-center">
          <SimpleDialogDemo/>
        </CardBox>
        <CardBox styleName="col-lg-3 col-md-6" cardStyle="p-0 mb-0" childrenStyle="text-center">
